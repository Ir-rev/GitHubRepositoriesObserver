...
data class RepositoriesResponseModel(
    ...
    @SerializedName("owner") var owner: RepositoriesOwnerModel? = RepositoriesOwnerModel(),
    ...
    @SerializedName("permissions") var permissions: RepositoriesPermissionsModel? = RepositoriesPermissionsModel()
